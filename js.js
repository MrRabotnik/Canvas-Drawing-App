...
let cursorImages = {
    ...
    tool_square_fill:"all-scroll",
    tool_square_stroke:"all-scroll",
    tool_circle_fill:"all-scroll",
    tool_circle_stroke:"all-scroll",
...
function Draw(e){
    ...
    switch(currentToolId){
        ...
        default:   
            nulifyingEverythingWithTools(); 
            $("#canvas").css({
                cursor: "url('Images/Cursors/pencil_cur.png'), auto",
            })
            ctx.lineCap = "round";
            ctx.lineTo(e.clientX,e.clientY - tool_container_height + 0.5);
            ctx.stroke();
